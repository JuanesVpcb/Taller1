...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que un atleta representa");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Muestra el país al que un atleta representa en los Juegos Olímpicos
	 */
	private void ejecutarPaisDeAtleta()
	{
		System.out.println("\nPaís al que un atleta representa\n");
		
		String name = input("Por favor ingrese el nombre del atleta del que desea conocer el país");
		String country = calculadora.atletaPorNombre(name);
		
		if (country != "Ninguno")
			System.out.println("El país al que " + name + " representa es " + country + ".");
		else 
			System.out.println("El país al que " + name + "representa no se encontró.");
	}
