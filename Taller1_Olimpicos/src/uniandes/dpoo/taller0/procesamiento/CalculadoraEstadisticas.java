...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el objeto de tipo String que coincida con el nombre del país del atleta
	 * 
	 * 
	 * @param name El nombre del atleta del que buscan el país
	 * @return El nombre del país del atleta
	 */
	public String atletaPorNombre(String name)
	{
		Atleta info = null;
		for (int i = 0; i < atletas.size() && info == null; i++)
		{
			if (atletas.get(i).darNombre().equals(name))
				info = atletas.get(i);
		}
